...
- geocode_gui_ver2 と同じロジックをブラウザUIに移植
- Excel/CSV をアップロード → 郵便番号/住所突合 → ジオコーディング → 結果/地図HTMLをダウンロード
"""
...
from geocode_gui_ver2 import (
    CACHE_DIR,
    GLOBAL_CACHE_PATH,
    OUTPUT_SUFFIX,
    add_geocode_columns,
    attach_master_by_address,
    attach_master_by_zip,
    create_map_html,
    geocode_addresses,
    load_cache,
    read_master,
